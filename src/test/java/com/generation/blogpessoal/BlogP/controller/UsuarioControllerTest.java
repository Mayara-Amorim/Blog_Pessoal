package com.generation.blogpessoal.BlogP.controller;
...
import com.generation.blogpessoal.BlogP.repository.UsuarioRepository;
import com.generation.blogpessoal.BlogP.service.UsuarioService;
...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		HttpEntity<Usuario>corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L, "Paulo Antunes", "paulo_antunes@gmail.com", "123456789", " "));
	...
	public void naoDeveDuplicarUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario> (new Usuario(0L,"Maria da Silva", "maria@gmail.com", "123456789", " "));
		ResponseEntity<Usuario> corpoResposta = testRestTemplate.exchange("/usuarios/cadastrar", HttpMethod.POST, corpoRequisicao, Usuario.class);
	...
	public void atualizarUmUsuario() {
		...
		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get()
				.getId(), "Juliana Andrews Ramos", "juliana_ramos@gmail.com", "123456789", " ");
